...
// Source: feeder-service/internal/sku/ui/socket/tcp/sku_reader (interfaces: SkuReader)
...
func (m *MockSkuReader) Read() (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSkuReaderMockRecorder) Read() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Read", reflect.TypeOf((*MockSkuReader)(nil).Read))
}
